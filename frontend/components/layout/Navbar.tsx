    ...
    <>
      ...
      {mobileMenuOpen && (
        <div
          ...
          className="fixed inset-0 z-[60] bg-white animate-in slide-in-from-right-full duration-300 md:hidden flex flex-col"
        >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <button
            ...
            className="cursor-pointer group w-auto md:w-64 text-left"
            onClick={() => onScrollTo("hero")}
          >
            <span
              className={`font-extrabold text-lg md:text-2xl transition-colors duration-300 ${
          ...
          <div className="hidden md:flex items-center justify-center">
            <div
              className={`flex gap-2 p-2 rounded-full border transition-all ${
                scrolled
