      ...
      <div className="max-w-7xl mx-auto px-4 w-full relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {TEAM_MEMBERS.map((member) => (
            <div
              key={member.name}
              className="group bg-white p-10 rounded-2xl border border-gray-200 hover:border-orange-300 hover:shadow-2xl transition-all duration-300 flex flex-col items-center text-center relative overflow-hidden"
            >
              ...
              <div className="mt-2">
                ...
                <p className="text-orange-600 text-sm uppercase font-bold mb-6">
                  {member.role}
                </p>
              </div>
              ...
              <div className="flex gap-4 mt-auto">
                <a
                  ...
                  target="_blank"
                  className="p-2 rounded-full text-gray-400 hover:bg-[#0077b5] hover:text-white transition-all"
                >
                ...
                <a
                  href={member.github}
                  target="_blank"
                  className="p-2 rounded-full text-gray-400 hover:bg-[#333] hover:text-white transition-all"
                >
                  <Github className="h-5 w-5" />
                </a>
                <a
                  href={member.email}
                  className="p-2 rounded-full text-gray-400 hover:bg-orange-500 hover:text-white transition-all"
                >
